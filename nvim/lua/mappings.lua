...
M.setup = function()
	...
	vim.keymap.set("n", "<leader>c", ":+y<CR>", vim.tbl_extend("force", opts, { desc = "Copy selected text to system clipboard" }))

	-- Copy a single line to system clipboard
	vim.keymap.set("n", "<leader>cl", ":+yy<CR>", vim.tbl_extend("force", opts, { desc = "Copy a single line to system clipboard" }))
